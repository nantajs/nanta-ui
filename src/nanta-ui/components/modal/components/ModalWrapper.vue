...
import type { Fn, ElRef, ComponentRef } from '../../..'
import { useWindowSizeFn } from '../../../core/hooks/useWindowSizeFn';
import ScrollContainer from '../../container/ScrollContainer.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    useWindowSizeFn(setModalHeight.bind(null, false) as Fn);
